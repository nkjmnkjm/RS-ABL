...
class predict_model():
    ...
    def get_param(self):
        baseline_param = "coef: " + ", ".join(str(d) for d in self.baseline_model.coef_) + " intercept: " + str(
            self.baseline_model.intercept_)
        rate_param = "coef: " + ", ".join(str(d) for d in self.rate_model.coef_) + " intercept: " + str(
            self.rate_model.intercept_)
